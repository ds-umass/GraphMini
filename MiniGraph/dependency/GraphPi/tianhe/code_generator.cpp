...
void code_gen(Graph *g, const Pattern &pattern, int performance_modeling_type, int restricts_type,
              bool use_in_exclusion_optimize, char *argv[]) {
    using namespace std;
