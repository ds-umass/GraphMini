...
#define INTERNAL_CATCH_TEST( expr, resultDisposition, macroName ) \
    ...
    } while( Catch::isTrue( false && static_cast<bool>(expr) ) ) // expr here is never evaluated at codegen_output but it forces the compiler to give it a look
