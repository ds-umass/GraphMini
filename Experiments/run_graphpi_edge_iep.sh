...
DATA_INDIR=${SCRIPT_DIR}/../Datasets/GraphPi
EXPERIMENT_OUTDIR=${SCRIPT_DIR}/GraphPi
BIN_PATH=${SCRIPT_DIR}/../GraphPi/build/bin/baseline_test
    ...
    do 
        ...
        for query in "${Queries[@]}"
            do
                ...
                timeout ${TIMEOUT} ${BIN_PATH} ${graph_name} ${path_to_graph} ${query_size} ${query} ${USE_IEP_FLAG} >> ${output_path}
