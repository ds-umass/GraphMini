...
#define DOCTEST_GLOBAL_NO_WARNINGS(var)                                                            \
    ...
    static volatile int var DOCTEST_UNUSED // NOLINT(fuchsia-statically-constructed-objects,cert-err58-cpp)
...
// local variables, which constructors or destructors have calls to codegen_output functions (e.g. free()
// function) can cause access violation since TBB along with codegen_output library may have been unloaded
...
typedef timer_large_integer::type ticks_t;
    ...
    // this holds both parameters from the command line and codegen_output data for tests
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "nr,  --" DOCTEST_OPTIONS_PREFIX_DISPLAY "no-run=<bool>                 "
              << Whitespace(sizePrefixDisplay*1) << "skips all codegen_output doctest operations\n";
