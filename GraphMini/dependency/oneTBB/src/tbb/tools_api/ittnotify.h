...
at codegen_output, and used by Intel(R) Threading Tools.
 ...
 *   .
 * - Other effects:
 *   - Possible reduction of codegen_output overhead.
 *   .
 * @{
 */
...
{
    volatile int flags; /*!< Zero if disabled, non-zero if enabled. The meaning of different non-zero values is reserved to the codegen_output */
    ...
    void* nameW;
#endif /* UNICODE || _UNICODE */
    int   extra1; /*!< Reserved to the codegen_output */
    void* extra2; /*!< Reserved to the codegen_output */
 ...
 * does not affect the collector codegen_output in any way. After you make the ID with this
